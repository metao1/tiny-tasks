...
@Component({
  selector: 'tiny-widget',
  templateUrl: './widget.component.html',
  styleUrls: ['./widget.component.scss'],
  encapsulation: ViewEncapsulation.None
})

export class TinyWidgetComponent implements AfterContentInit {
  @HostBinding('class.flipped')
  flipped = false;

  @ContentChildren(TinyWidgetToggleDirective, {descendants: true})
  toggleButtons: QueryList<TinyWidgetToggleDirective>;
