...
import {TinySidebarService} from './sidebar.service';
import {TinyMatchMediaService} from '@tiny/services/match-media.service';

@Component({
  selector: 'tiny-sidebar',
  templateUrl: './sidebar.component.html',
  styleUrls: ['./sidebar.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class TinySidebarComponent implements OnInit, OnDestroy {
  // Name
  @Input()
  name: string;
  ...
  set folded(value: boolean) {
    ...
    if (value) {
      ...
      // Set the folded height
      this._renderer.setStyle(this._elementRef.nativeElement, 'height', styleValue);
      this._renderer.setStyle(this._elementRef.nativeElement, 'min-width', styleValue);
      this._renderer.setStyle(this._elementRef.nativeElement, 'max-height', styleValue);
    ...
    // If unfolded...
      ...
      // Remove the folded height
      this._renderer.removeStyle(this._elementRef.nativeElement, 'height');
      this._renderer.removeStyle(this._elementRef.nativeElement, 'min-width');
      this._renderer.removeStyle(this._elementRef.nativeElement, 'max-height');
  ...
  ngOnInit(): void {
    ...
    this.tinySidebarService.register(this.name, this);
  ...
  ngOnDestroy(): void {
    ...
    this.tinySidebarService.unregister(this.name);
  ...
  private _showBackdrop(): void {
    ...
    this._backdrop.classList.add('tiny-sidebar-overlay');

    // Add a class depending on the invisibleOverlay option
    if (this.invisibleOverlay) {
      this._backdrop.classList.add('tiny-sidebar-overlay-invisible');
    }
