...
@Directive({
  selector: '[tinyPerfectScrollbar]'
})
export class TinyPerfectScrollbarDirective implements AfterViewInit, OnDestroy {
   ...
   */
  @Input()
  set tinyPerfectScrollbarOptions(value) {
    // Merge the options
    this._options = _.merge({}, this._options, value);
  }

  get tinyPerfectScrollbarOptions(): any {
    // Return the options
  ...
  ngAfterViewInit(): void {
    ...
    if (this.tinyPerfectScrollbarOptions.updateOnRouteChange) {
      this._router.events
        .pipe(
  ...
  _init(): void {
    ...
    this.ps = new PerfectScrollbar(this.elementRef.nativeElement, {
      ...this.tinyPerfectScrollbarOptions
    });
  }
